...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianNeRFModel, shuffle=True, resolution_scales=[1.0]):
        """b
        ...
        self.create_mesh()
        self.gaussians.setup_training_input(self, self.vertices, self.triangles)

    def create_mesh(self, center_point = (0, 0, 0), radius = [2, 1], n_subdivisions = 2):
